...
def process(num: int, show: bool = False, hide: bool = False) -> None:
	...
	# (250000002004000000000000000008000000000(4000000000000))000000000000000000000000000000
	# (2500000020040000000000000000000000000084000000000000)000000000000000000000000000000
